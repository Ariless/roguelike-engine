...
`BUGS.md` contains 23 real bugs found during implementation. Each has:
- What failed
- Root cause
- What test would have caught it earlier

**This is the most important file in the repository.** Read all 23 entries.
...
| File | What it is |
|------|-----------|
| `BUGS.md` | 23 real bugs — testing ROI in action |
