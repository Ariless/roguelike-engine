...
`BUGS.md` contains 22 real bugs found during implementation. Each has:
- What failed
- Root cause
- What test would have caught it earlier

**This is the most important file in the repository.** Read all 22 entries.
...
| File | What it is |
|------|-----------|
| `BUGS.md` | 22 real bugs — testing ROI in action |
